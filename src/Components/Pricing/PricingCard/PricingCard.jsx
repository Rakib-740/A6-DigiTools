...
const PricingCard = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 gap-15'>
            <div className="card w-96 min-h-101 h-full shadow-xl bg-base-200 drop-shadow-2xl">
            ...
            <div className="card w-96 min-h-101 h-full shadow-xl drop-shadow-2xl bg-linear-to-tl from-[#4F39F6] to-[#9514FA] text-white">
                <div className="card-body space-y-3">
            ...
            <div className="card w-96 min-h-101 h-full shadow-xl drop-shadow-2xl bg-base-200">
                <div className="card-body space-y-3">
